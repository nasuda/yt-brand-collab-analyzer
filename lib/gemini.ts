...
固定パート（ブランドが求める部分）と自由パート（クリエイターに任せる部分）を明示する。
例: 「導入: [クリエイター自由] いつもの挨拶・導入 → 展開: [クリエイター自由] ○○の文脈で自然に商品に触れる → ブランドモーメント: [固定] 商品名と主要ベネフィットを自分の言葉で伝える → 締め: [クリエイター自由] 感想・視聴者への問いかけ」
